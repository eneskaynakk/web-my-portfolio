        ...
        <div className="z-50 mx-auto flex h-full w-2/3 flex-col justify-center xl:w-[500px]">
          ...
          <div className="mt-10">
            <form action="">
                    ...
                    <div className="mt-8">
                        <button type="submit" className="cursor-pointer hover:bg-green-600 hover:text-gray-700 hover:ring hover:ring-gray-700 transition duration-300 inline-flex items-center justify-center rounded-full text-base focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 bg-white text-black py-4 w-full">Login</button>
                    </div>

                    <div className=" flex justify-end">
                        <p className="flex mr-3 my-7 text-white rounded-lg">Don{"'"}t you have an account?</p>
                        <Link href="/auth/register" className="bg-white text-black h-10 px-4 py-2 my-5 hover:bg-green-600 hover:text-gray-700 hover:ring hover:ring-gray-700 transition duration-300 inline-flex items-center justify-center rounded-md text-sm focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 ">
                            Sign Up
                        </Link>
                    </div>
                </form>
