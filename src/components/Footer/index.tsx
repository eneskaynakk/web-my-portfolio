        ...
        <footer className="bg-black relative">
            ...
            <div className="relative container mx-auto pt-16 pb-16">
                ...
                <div className='flex justify-between'>
                    ...
                    <div className='flex flex-col'>
                        ...
                        <div className="flex space-x-4">
                            <Link href="https://www.linkedin.com/in/enes-kaynak/" className="rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg group">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 50 50" fill="#f5f5f5">
                            ...
                            <Link href="https://github.com/eneskaynakk" className="rounded-lg transition-all duration-300 hover:scale-110 hover:shadow-lg group">
                                <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="28" height="28" viewBox="0 0 30 30" fill="#f5f5f5">
                    ...
                    <div className='flex flex-col'>
                        <h3 className="text-lg font-semibold mb-4 text-t-white">Get In Touch</h3>
                        <ul className="space-y-3">
                            <li>
                                <Link href="/" className="text-gray-300 hover:text-t-gold transition-colors duration-200 hover:translate-x-1 transform inline-block">
                                    Start a Project
            ...
            <div className="container mx-auto border-t border-t-white pt-8 pb-8 flex flex-col md:flex-row items-center justify-between">
