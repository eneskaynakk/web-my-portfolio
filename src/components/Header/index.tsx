            ...
            <nav className="fixed w-full z-50 bg-gradient-to-b from-b-black/90 to-transparent backdrop-blur-md">
                <div className='px-8 py-4 lg:px-0 lg:py-0 lg:container lg:mx-auto'>
                        ...
                        {isOpenSearch && (
                            <div className="fixed top-0 left-0 h-68 rounded-b-lg w-screen p-4 bg-black flex flex-col">
                                ...
                                <div className="flex flex-col gap-4 pl-2 pt-10 rounded-lg overflow-y-auto flex-grow">
                                    ...
                                    <button onClick={() => {scrollToElement(".certificate"); setOpenSearch(false);}} className="flex gap-2 items-center text-t-white font-text text-lg focus:bg-t-gold transition-colors duration-200 ease-in-out rounded-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-file-text-icon lucide-file-text">
                                            <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/>
                                            <path d="M14 2v4a2 2 0 0 0 2 2h4"/>
                                            <path d="M10 9H8"/><path d="M16 13H8"/><path d="M16 17H8"/>
                                    ...
                                    <button onClick={() => {scrollToElement(".contact"); setOpenSearch(false)}} className="flex gap-2 items-center text-t-white font-text text-lg focus:bg-t-gold transition-colors duration-200 ease-in-out rounded-lg">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-file-text-icon lucide-file-text">
                                            <path d="M15 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V7Z"/>
                                            <path d="M14 2v4a2 2 0 0 0 2 2h4"/>
                                            <path d="M10 9H8"/><path d="M16 13H8"/><path d="M16 17H8"/>
                    ...
                    <div className="flex justify-between items-center py-6">
                        ...
                        <button onClick={() => scrollToElement(".contact")} className="px-3 py-2 bg-transparent border border-t-gold text-t-gold hover:bg-t-gold hover:text-t-white transition-all duration-300 uppercase tracking-widest font-header-text text-sm cursor-pointer">
                            Contact Us
                        </button>
